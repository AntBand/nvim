...
vim.opt.matchtime = 2               -- How to to show matching brackets
...
vim.keymap.set("n", "<leader>so", ":update<CR> :source<CR>", { desc = "Source file" })
...
local function smart_close_buffer()
  ...
  if buffers_in_tab > 1 then
    ...
    -- If it[48;51;115;918;920t's the only buffer in tab, close the tab
    vim.cmd('tabclose')
  end
end
